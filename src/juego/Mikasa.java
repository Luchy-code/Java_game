...
public class Mikasa {
	...
	public Mikasa(double x, double y) {
		this.x = x;
		this.y = y;
		this.flecha = Herramientas.cargarImagen("img/flecha.png");
	}
	...
	public void dibujarse(Entorno entorno) {
		...
		if (this.kyojina) {
			this.imagen = Herramientas.cargarImagen("img/kyojina.png");
			...
			if (this.voltear) {
				this.imagen = Herramientas.cargarImagen("img/mikasaIZQ.png");
			}

			else {
				this.imagen = Herramientas.cargarImagen("img/mikasaDER.png");
			}
