...
public class Juego extends InterfaceJuego {
	...
	Juego() {
		...
		this.entorno = new Entorno(this,"Juan Vernon Petre, Luciana Oviedo, Joaquin Flores y Jorge Jimenez - Grupo 10 - Attack on Titan", 800, 600);
		fondo = Herramientas.cargarImagen("img/fondo.png");
		...
		eliminados = 0;
		ganaste = Herramientas.cargarImagen("img/ganaste.png");
		perdiste = Herramientas.cargarImagen("img/perdiste.png");
		vida = 2;
	...
	public void tick() {
		if (jugando == true) {
			...
			if (cantidadKyojines(kyojines) == 0) {
				...
				Herramientas.cargarSonido("img/ganaste.wav").start();
			}
			...
			if (mikasa != null) {
				...
				if ((entorno.estaPresionada(entorno.TECLA_ESPACIO)) && (!mikasa.disparo)) {
					...
					mikasa.disparo = true;
					Herramientas.cargarSonido("img/disparo.wav").start();
				}
